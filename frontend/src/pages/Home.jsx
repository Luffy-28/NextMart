  ...
  const testimonials = [
    {
      ...
      quote:
        "The collection is absolutely stunning. I found pieces I couldn't find anywhere else!",
    ...
    },
    {
      ...
      quote:
        "Fast shipping and great customer service. My gadgets arrived in perfect condition.",
    ...
    },
    {
      ...
      quote:
        "Love the home decor section. It adds such a unique touch to my projects.",
    ...
    },
    {
      ...
      role: "Verified Buyer",
      quote:
        "Unbeatable prices and high-quality products. NexMart is my new favorite shop!",
    ...
    <>
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <Reveal>
                ...
                <p
                  className="lead mb-4 nex-hero-sub"
                  ...
                  {[
                    ...
                    <div className="col-4" key={s.label}>
                      <div className="nex-stat-item">
                        ...
                        <div>
                          <div
                            className="fw-bold lh-1 nex-gradient-text"
            ...
            <div className="col-lg-6 d-none d-lg-block">
              <Reveal delay={150} x={20} y={0}>
                <div className="position-relative" style={{ height: "500px" }}>
                  <div
                    className="nex-float-card position-absolute"
                    style={{ top: 0, right: 0, width: "290px", zIndex: 3 }}
                  >
                    <img
                    ...
                    <div style={{ padding: "14px 16px" }}>
                      ...
                      <h6 className="mt-2 mb-1 nex-text-light fw-semibold">
                        Premium Headphones
                      </h6>
                  ...
                  <div
                    className="nex-float-card position-absolute"
                    style={{ bottom: 0, left: 0, width: "255px", zIndex: 2 }}
                  >
                    <img
                  ...
                  <div
                    className="nex-float-badge position-absolute"
                    style={{ top: "44%", left: "-6%", zIndex: 4 }}
                  >
                    <div
                      className="d-flex align-items-center justify-content-center rounded-circle nex-icon-grad"
                      style={{ width: "40px", height: "40px", flexShrink: 0 }}
                    >
                      <i className="bi bi-truck text-white" />
                    </div>
                    <div>
                      <div className="fw-bold small nex-text-light">
                        Free shipping
                      </div>
                      <small className="nex-text-muted">
                        On orders over $50
                      </small>
                    </div>
                  </div>
            ...
            {[
              ...
              <div className="col-6 col-md-3" key={f.title}>
                <div className="d-flex align-items-center gap-2 justify-content-center justify-content-md-start">
                  <i
                    className={`bi ${f.icon} nex-text-purple`}
                    style={{ fontSize: "1.6rem" }}
                  />
                  <div>
                    <div className="fw-semibold small nex-text-light">
                      {f.title}
                    </div>
        ...
        <div className="container">
          <Reveal>
            <div className="text-center mb-5">
              ...
              <p className="lead nex-text-muted">
      ...
      <section className="my-5">
        <div className="container">
          <Reveal>
            <div
              className="nex-banner position-relative rounded-4 overflow-hidden text-white text-center"
              style={{
                minHeight: "420px",
                backgroundImage:
            ...
            >
              ...
              />
              <div
                className="position-relative d-flex flex-column justify-content-center align-items-center p-5"
                style={{ minHeight: "420px", zIndex: 2 }}
              >
                <span className="nex-pill mb-3">MEGA SALE</span>
                <h2 className="display-3 fw-bold mb-3 text-white">
                  Up to{" "}
                  <span className="display-2 nex-gradient-text">50% OFF</span>{" "}
                  Sitewide
                </h2>
                <p
                ...
                >
                  Limited-time offer ends soon. Don't miss out on our biggest
                  sale of the year.
                </p>
          ...
          <div className="d-flex justify-content-between align-items-end flex-wrap gap-2 mb-5">
            <div>
              <Reveal>
                ...
                <p className="nex-text-muted mb-0">
              ...
              <div className="col-md-6 col-lg-3" key={t.id}>
                <Reveal delay={i * 100}>
                  <div className="nex-testimonial-card">
                    ...
                    <p
                      className="my-4 fst-italic nex-text-muted"
        ...
        <div className="container">
          <Reveal>
            <div className="nex-newsletter">
              <i
                className="bi bi-envelope-paper-fill nex-gradient-text d-block mb-3"
                style={{ fontSize: "3.2rem" }}
              />
              <h2 className="display-5 fw-bold nex-text-light mb-3">
                Get <span className="nex-gradient-text">10% off</span> your
                first order
              </h2>
              <p
                className="lead nex-text-muted mx-auto mb-4"
                style={{ maxWidth: "520px" }}
              >
                Join the NexMart newsletter for exclusive deals, early access,
                and a welcome discount.
              </p>
              <form
              ...
              >
                <div className="nex-email-group">
                  ...
                  <input
                    type="email"
                    className="nex-email-input"
                    placeholder="you@email.com"
                    required
                  />
                  <button type="submit" className="nex-email-btn">
                    Subscribe
                  </button>
                </div>
              </form>
